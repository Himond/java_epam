...
public class MainCountry {
    public static void main(String[] args) {
        ...
        City city1 = new City("Minsk", new District[]{district1, district2}, CategoriesCities.DISTRICT);
        ...
        City city2 = new City("Mogilev", new District[]{district3, district4}, CategoriesCities.REGIONAL);
        Region region = new Region(new City[]{city1, city2}, CategoriesCities.CAPITAL);
